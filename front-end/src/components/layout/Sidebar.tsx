...
const navItems: NavItem[] = [
  ...
  { title: 'Employees', href: '/employees', icon: Users, roles: ['SUPERADMIN','ADMIN','EMPLOYEE', 'HR', 'MANAGER'] },
  ...
  // { title: 'Assets', href: '/assets', icon: Laptop, roles: ['EMPLOYEE', 'HR'] },
  // { title: 'Travel & Expense', href: '/travel', icon: Plane, roles: ['EMPLOYEE', 'HR', 'MANAGER'] },
  // { title: 'Disciplinary', href: '/disciplinary', icon: AlertTriangle, roles: ['admin', 'hr'] },
  // { title: 'Grievance', href: '/grievance', icon: MessageSquare, roles: ['EMPLOYEE', 'HR', 'MANAGER'] },
